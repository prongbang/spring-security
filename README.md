...
('user', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', 1)
INSERT INTO [dbo].[users] ([username], [password], [enabled]) VALUES
('admin', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', 1)
INSERT INTO [dbo].[users] ([username], [password], [enabled]) VALUES
('dba', '5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8', 1)
-- 
-- Table authorities
-- 
	...
	<li>
		...
		<ul>
			...
			<li>
				...
				<ul>
					<li>
						<h4>Custom login using dao – UserDetailsService</h4>
					</li>
					<li>
						<h4>Jdbc Template</h4>
					</li>
					<li>
						<h4>Named Parameter Jdbc Template</h4>
					</li>
				</ul>
			</li>
			<li>
			...
			<li>
				<h4>Download:</h4>
				<ul>
					<li><a href="https://github.com/prongbang/spring-security/releases/tag/v1.0.5" target="_blank">Source Code</a></li>
				</ul>
			</li>
		</ul>
	</li>
